...
//========================================================================
//                                                                      //
// Table to display the data of the atomic structures.                  //
//                                                                      //
//======================================================================//
 ...
 * ===================
 *
 * Returns the slected in a table.
 */
int CTable::row() {
  return Row;
}
 ...
 * ======================
 *
 * Returns the slected column in a table.
 */
int CTable::column() {
  return Col;
}
...
int CTable::handle(int event) {
  ...
  case FL_PUSH:
    ...
    where(Fl::event_x(), Fl::event_y(), Row, Col, resize);
    ...
    switch (Row) {
      ...
      default:
        ...
        // Show popup menu
        if((Fl::event_button() == FL_RIGHT_MOUSE) && (popupMenu != NULL)) {
        ...
        // Callback
        if((Fl::event_clicks() != 0) && !changed && (when() & TABLE_WHEN_DCLICK)) {
          Fl::event_is_click(0);
          do_callback();
        }
